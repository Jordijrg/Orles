        ...
        <nav class="navbar dark:bg-gray-900 border-inherit">
            <ul class="navbar__menu">
                <li class="navbar__item">
                    <a href="/index" class="navbar__link cursor-pointer"><i
                            data-feather="home"></i><span>Inici</span></a>
                </li>
            ...
            <tbody>
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 cursor-pointer"
                    ...
                    <th scope="row" class="flex items-center px-6 py-4 text-gray-900 whitespace-nowrap dark:text-white">
                        <a class="navbar__link"><i data-feather="plus"></i></a>
                        <div class="ps-3">
                            <div class="text-base font-semibold">Importar Usuaris</div>
                    ...
                    <div class="relative p-4 w-full max-w-2xl max-h-full">
                        ...
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <div class="p-4 md:p-5 space-y-4">
                                <h1 class="text-lg font-semibold mb-4">Importar Usuaris</h1>
                                <form id="csvForm" method="POST" action="/userimport" enctype="multipart/form-data">
                                    <label for="csvFile">Selecciona un arxiu CSV:</label>
                                    <input name="CSV" type="file" id="csvFile" accept=".csv" required>
                                    <button class="text-white inline-flex items-center bg-lime-500 hover:bg-lime-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-lime-500 dark:hover:bg-lime-700 dark:focus:ring-blue-800" 
