            ...
            <ul class="navbar__menu">
                ...
                if ($user["rol"] === "equip_directiu" || $user["rol"] === "profe" || $user["rol"] === "admin") { ?>
                    <li class="navbar__item">
                        <a href="/editororles" class="navbar__link cursor-pointer"><i
                                data-feather="message-square"></i><span>Plantilles</span></a>
                    </li>
                    <?php
                }
                ?>
        ...
        <div
            ...
            <div class="relative">
                ...
                <input type="text" id="table-search-users"
                    ...
                    aria-label="Buscador per usuaris">
        ...
        <div
            ...
            <div class="relative">
                ...
                <input type="text" id="table-search-grups"
                    class="block pt-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg w-80 bg-gray-50 focus:ring-blue-500 focus:border-blue-50 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    aria-label="Buscador per grups">
            </div>
        </div>
