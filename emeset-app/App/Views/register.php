      ...
      <div
        ...
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
          ...
          <form method="POST" class="space-y-4 md:space-y-6" action="/register">
            ...
            <button type="submit"
              class="w-full bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 bg-gray-200 focus:animate-ping animate-once">
            Registra't</button>
            <p class="text-sm font-light text-gray-500 dark:text-gray-400">
              Ja tens una compta? <a href="/login"
                class="font-medium text-primary-600 hover:underline dark:text-primary-500 focus:animate-ping animate-once">Inicia Sessio</a>
            </p>
          </form>
        </div>
      </div>
