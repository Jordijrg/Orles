        ...
        <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg dark:bg-gray-800 dark:border-gray-700 border-none ">
            ...
            <div class="flex flex-col items-center pb-10 justify-center">
                ...
                <div class="flex mt-4 md:mt-6 justify-center"> 
                    ...
                    <a href="#" data-modal-target="static-modal2" data-modal-toggle="static-modal2" class="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-gray-900 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-700 dark:focus-ring-gray-700 ms-3">Canviar la foto</a>
                </div>
                </div>
            </div>
