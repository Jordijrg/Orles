...
<body class="dark:bg-gray-900">
    ...
    <div class=" px-4 mx-auto max-w-screen-xl">
        <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg md:p-12 mb-4 mt-4">
            <center>
                <div
                    class="w-full max-w-sm bg-white border border-gray-200 rounded-lg dark:bg-gray-800 dark:border-gray-700 border-none">
                    <div class="flex flex-col items-center pb-10">
                        <img class="w-24 h-24 mb-3 rounded-full shadow-lg" src="/images/inici.png" alt="Bonnie image" />
                        <h5 class="mb-1 text-xl font-medium text-gray-900 dark:text-white">
                            <?= $usuaris['Nom'] . " " . $usuaris['Cognom'] ?>
                        </h5>
                        <span class="text-sm text-gray-500 dark:text-gray-400">
                            <?= $usuaris['Correu']."<br>" .$usuaris['Nomgrup']?>
                            
                        </span>
                        <div class="flex mt-4 md:mt-6">
                            <a href="#" data-modal-target="static-modal" data-modal-toggle="static-modal"
                                class="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-gray-900 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-700 dark:focus:ring-gray-700 ms-3">Veure
                                el carnet</a>
                            <a href="#"
                                class="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-gray-900 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-700 dark:focus:ring-gray-700 ms-3">Enviar
                                un missatge</a>
                        </div>
                    </div>
                </div>
    ...
    <div class=" px-4 mx-auto max-w-screen-xl">
        <div id="usuaris"
            class="w-full max-w-screen p-4 bg-white border border-gray-200 rounded-lg shadow  dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <div class="flex-1 min-w-0 ms-4">
                                ...
                                <p class="text-sm text-gray-500 truncate dark:text-gray-400">
                                    <input type="text" name="Cognom" id="name"
                                        class="dark:bg-gray-800 border-none w-full" required=""
                                        value="<?= $usuaris['Nom'] ?>" disabled>
                                </p>
                            </div>
                        </div>
                    </li>
                        ...
                        <li class="py-3">
                            <div class="flex items-center">
                                <div class="flex-1 min-w-0 ms-4">
                                    ...
                                    <p class="text-sm text-gray-500 truncate dark:text-gray-400">
                                        <input type="hidden" name="IdUsuari" id="name"
                                            class="dark:bg-gray-800 border-none w-full" required=""
                                            value="<?= $usuaris['IdUsuari'] ?>">
                                ...
                                <div class="flex-1 min-w-0 ms-4">
                                    ...
                                    <p class="text-sm text-gray-500 truncate dark:text-gray-400">
                                        <input type="text" name="Contrasenya" id="name"
                                            class="dark:bg-gray-800 border-none w-full">
                                    </p>
                                </div>
                            </div>
                        </li>
